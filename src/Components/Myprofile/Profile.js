                ...
                <Tab eventKey="work information " title="work information" >
                   <Form>
                    ...
                    <Row>
                        ...
                        <Col xs={4} className={select1?'showticked1':'showticked'}>
                        <Form.Group className='mb-3 mt-2' >
                    ...
                    <Row>
                        ...
                        <Form.Group className='mb-3 mt-2'>
                           ...
                           <Form.Check type='radio'  name="consultancy" label="No" className='mx-3'onClick={handleSelect1} />
                           </div>
                       </Form.Group>        
                        </Col>
                    </Row>
                    <Row>
                        ...
                        <Form.Group className='mb-3 mt-2'>
                           ...
                           <Form.Select type='text'  name="Ownportal" className='mt-3'>
                               ...
                               <option value="Monsterkkb">Monsterkkb</option>
